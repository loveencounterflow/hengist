(function() {
  'use strict';
  var CND, SL, badge, debug, echo, freeze, help, info, isa, provide, rpr, types, urge, validate, validate_optional, warn, whisper;
  ...
  provide = function() {
    ...
    //-----------------------------------------------------------------------------------------------------------
    return this.$sample = function(p = 0.5, settings) {
...
//# sourceMappingURL=steampipes-extras.js.map