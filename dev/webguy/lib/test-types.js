(function() {
  'use strict';
  var GUY, alert, debug, demo, demo_combinate, demo_combinate_2, demo_enumerate_hedgepaths, demo_hedges, demo_intertype_autovivify_hedgepaths, demo_intertype_hedge_combinator, demo_multipart_hedges, demo_picomatch_for_hedgepaths, demo_size_of, demo_test_with_protocol, echo, help, info, inspect, isa, jr, list_all_builtin_type_testers, log, plain, praise, rpr, test, types, urge, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["_intertype size_of"] = async function(T, done) {
    var Intertype, error, i, len, matcher, probe, probes_and_matchers;
...
//.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_all_hedgepaths = async function(T, done) {
    var Intertype, Type_cfg, declare, error, i, len, matcher, probe, probes_and_matchers, value;
...
// [ 'isa.optional.nonempty.set.of.optional.nonempty.set',   ( null                                      ), true, ]
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x___demo_hedgepath_resolution = function() {
    var Intertype, Type_cfg, _, callable, declare, error, hedges, i, len, matcher, probe, probes_and_matchers, result, value;
    // T?.halt_on_error true
    ({Intertype, Type_cfg} = require('../../../apps/intertype'));
    types = new Intertype();
    ({declare, isa} = types);
...
//.........................................................................................................
  ...
  demo_combinate_2 = function() {
    var Intertype, Type_cfg, combinate, combinations, combine, hedges;
    ({Intertype, Type_cfg} = require('../../../apps/intertype'));
    types = new Intertype();
    combinate = (require("combinate")).default;
    //.........................................................................................................
  ...
  demo_intertype_hedge_combinator = function() {
    ...
    ({Intertype, Type_cfg} = require('../../../apps/intertype'));
    (() => {      //.........................................................................................................
      var compiled_hedges, groupname, hedgepaths, hedges, i, len, ref, results;
      types = new Intertype();
  ...
  demo_enumerate_hedgepaths = function() {
    var Intertype, evaluate, i, len, path, ref;
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  demo_intertype_autovivify_hedgepaths = function() {
    var Intertype, declare, validate;
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__validate_1 = function(T, done) {
    var Intertype, declare, validate;
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__validate_returns_value = function(T, done) {
    var Intertype, d, error;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
    //.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__create_returns_deep_copy_of_template = function(T, done) {
    var Intertype, d, e, mylist;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
    //.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__create_with_seal_freeze_extra = function(T, done) {
    var Intertype;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__declare_NG_templates = function(T, done) {
    var Intertype;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__isa_x_or_y = function(T, done) {
    var Intertype, declare, e, error, validate;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
    ({declare, isa, validate} = types);
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_collection_of_t = function(T, done) {
    var Intertype, declare, error, validate;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
    ({declare, isa, validate} = types);
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_even_odd_for_bigints = function(T, done) {
    var Intertype, declare, validate;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_existential_types = function(T, done) {
    var Intertype, declare, validate;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_empty_and_nonempty = function(T, done) {
    var Intertype, declare, validate;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_declaration_with_per_key_clauses = function(T, done) {
    var Intertype;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    (() => {      //.........................................................................................................
      var create, declare, k, ref, v, validate;
      types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x___demo_type_cfgs_as_functions_1 = function() {
    var F, f;
    whisper('#############################################');
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x___demo_type_cfgs_as_functions_2 = function() {
    var Intertype, error, f;
    whisper('#############################################');
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_exception_guarding = function(T, done) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_check_complex_recursive_types = function(T, done) {
    var Intertype, create, declare, validate;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    //.........................................................................................................
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x___intertype_isa_arity_check = function(T, done) {
    var Intertype, e;
    if (T != null) {
      T.halt_on_error();
    }
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_normalize_type_cfg = async function(T, done) {
    var Intertype, TF, Type_factory, error, i, len, matcher, prep, probe, probes_and_matchers;
    // T?.halt_on_error()
...
//.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_tracing = async function(T, done) {
    var Intertype, create, declare, error, i, len, matcher, noresult, probe, probes_and_matchers, validate;
    if (T != null) {
      T.halt_on_error();
    }
    ({Intertype} = require('../../../apps/intertype'));
...
//.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x___intertype_tracing_2 = function(T, done) {
    var Intertype, cleanup, create, declare, noresult, validate;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype({
      errors: false
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_improved_validation_errors = function(T, done) {
    var Intertype, bad_probe, cleanup, create, declare, good_probe, noresult, validate;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype({
      errors: false
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x___intertype_demo_improved_validation_errors = function() {
    var Intertype, error;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype({
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x___demo_postconditions = function(T, done) {
    var Intertype, create, declare, error, plus_1, plus_2, validate;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
    ({declare, isa, validate, create} = types);
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x___intermezzo_private_class_features_in_coffeescript = function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_equals_distinguishes_positive_from_negative_zero = function(T, done) {
    var WG;
    WG = require('../../../apps/webguy');
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_can_use_detached_type_of_method = function(T, done) {
    var WG, type_of;
    WG = require('../../../apps/webguy');
    ({type_of} = types);
    if (T != null) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_type_regex = function(T, done) {
    var WG, show_error;
    WG = require('../../../apps/webguy');
    //.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_has_type_for_negative_zero = function(T, done) {
    var WG;
    WG = require('../../../apps/webguy');
    //.........................................................................................................
    if (T != null) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_has_data_property = function(T, done) {
    var WG;
    WG = require('../../../apps/webguy');
    //.........................................................................................................
    if (T != null) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_ordering_of_field_and_isa_tests = function(T, done) {
    var WG, collector, e;
    WG = require('../../../apps/webguy');
    //.........................................................................................................
    collector = [];
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_can_use_subobject_fields = function(T, done) {
    var Intertype, create, declare, noresult, validate;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype({
      errors: false
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_cast = function(T, done) {
    var Intertype, cast, collector, create, declare, e, show, type_of, validate, x;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype({
      errors: false
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_create_has_correct_binding = function(T, done) {
    var Intertype, cast, collector, create, declare, type_of, validate;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype({
      errors: false
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_create_may_return_frozen_sealed_value = function(T, done) {
    var Intertype, cast, collector, create, declare, type_of, validate;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype({
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_equals_available_as_module_static_method = function(T, done) {
    var Intertype, equals;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__intertype_asyncfunction_isnt_a_function = function(T, done) {
    var Intertype;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype({
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__override_types_are_honored = function(T, done) {
    var Intertype, declare;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype({
      errors: false
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__can_clone_instance = function(T, done) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__can_replace_declarations = function(T, done) {
    var Intertype, declare, type_of;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__can_delete_and_redeclare_types = function(T, done) {
    var Intertype, declare, remove, type_of;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__detect_circular_declarations = function(T, done) {
    var Intertype, declare, remove, type_of;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__strange_naming_bug = function(T, done) {
    var Intertype, declare, misfit;
    // T?.halt_on_error()
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__symbols = function(T, done) {
    var Intertype;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__throws_validation_error_for_unfit_arguments = function(T, done) {
    var Intertype, create, declare, type_of;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__recognize_classes = function(T, done) {
    var Intertype, X, create, declare, type_of;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
    ({declare, isa, type_of, create} = types);
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__is_extension_of_recognizes_derivatives = function(T, done) {
    var Base, Derived, Intertype, Unrelated, create, declare, is_extension_of, type_of;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__is_extension_of_allows_all_values = function(T, done) {
    var Base, Derived, Intertype, Unrelated, create, declare, is_extension_of, type_of;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__can_use_either_default_or_template = function(T, done) {
    var Intertype;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    (function() {      //.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__can_use_freeze_true_false_deep_shallow = function(T, done) {
    var Intertype;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    (() => {      //.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.___x__knowntype_metatype = function(T, done) {
    var Intertype;
    // T?.halt_on_error()
    ({Intertype} = require('../../../apps/intertype'));
    types = new Intertype();
