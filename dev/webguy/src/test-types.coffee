...
@types_isa_2 = ( T, done ) ->
  ...
  # T?.eq ( WG.types.isa.integer        ( null ) ), true
  # T?.eq ( WG.types.isa.cardinal       ( null ) ), true
  # T?.eq ( WG.types.isa.zero           ( null ) ), true
  ...
  # T?.eq ( WG.types.isa.class          ( null ) ), true
  #.........................................................................................................
  done?()
  return null
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_all_hedgepaths = ( T, done ) ->
...
#-----------------------------------------------------------------------------------------------------------
@___x___demo_hedgepath_resolution = ->
  # T?.halt_on_error true
  { Intertype
    Type_cfg }  = require '../../../apps/intertype'
  types         = new Intertype()
...
#-----------------------------------------------------------------------------------------------------------
@___x__validate_returns_value = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype } = require '../../../apps/intertype'
  types         = new Intertype()
  #.........................................................................................................
...
#-----------------------------------------------------------------------------------------------------------
@___x__create_returns_deep_copy_of_template = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype } = require '../../../apps/intertype'
  types         = new Intertype()
  #.........................................................................................................
...
#-----------------------------------------------------------------------------------------------------------
@___x__create_with_seal_freeze_extra = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype } = require '../../../apps/intertype'
  types         = new Intertype()
  # #.........................................................................................................
...
#-----------------------------------------------------------------------------------------------------------
@___x__declare_NG_templates = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype } = require '../../../apps/intertype'
  types         = new Intertype()
  #.........................................................................................................
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_collection_of_t = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype } = require '../../../apps/intertype'
  types         = new Intertype()
  { declare
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_even_odd_for_bigints = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype } = require '../../../apps/intertype'
  types         = new Intertype()
  { declare
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_existential_types = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype } = require '../../../apps/intertype'
  types         = new Intertype()
  { declare
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_empty_and_nonempty = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype } = require '../../../apps/intertype'
  types         = new Intertype()
  { declare
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_declaration_with_per_key_clauses = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype } = require '../../../apps/intertype'
  #.........................................................................................................
  do =>
...
#-----------------------------------------------------------------------------------------------------------
@___x___demo_type_cfgs_as_functions_1 = ->
  whisper '#############################################'
...
#-----------------------------------------------------------------------------------------------------------
@___x___demo_type_cfgs_as_functions_2 = ->
  whisper '#############################################'
  class Intertype
    create_type_cfg: ( cfg ) ->
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_exception_guarding = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_check_complex_recursive_types = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype } = require '../../../apps/intertype'
  #.........................................................................................................
  types             = new Intertype()
...
#-----------------------------------------------------------------------------------------------------------
@___x___intertype_isa_arity_check = ( T, done ) ->
  T?.halt_on_error()
  { Intertype } = require '../../../apps/intertype'
  #.........................................................................................................
  types = new Intertype()
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_normalize_type_cfg = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_tracing = ( T, done ) ->
  T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
...
#-----------------------------------------------------------------------------------------------------------
@___x___intertype_tracing_2 = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype { errors: false, }
  noresult          = Symbol 'noresult'
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_improved_validation_errors = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype { errors: false, }
  noresult          = Symbol 'noresult'
...
#-----------------------------------------------------------------------------------------------------------
@___x___intertype_demo_improved_validation_errors = ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype { errors: false, }
  try
...
#-----------------------------------------------------------------------------------------------------------
@___x___demo_postconditions = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types = new Intertype()
  { declare
...
#-----------------------------------------------------------------------------------------------------------
@___x___intermezzo_private_class_features_in_coffeescript = ->
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_equals_distinguishes_positive_from_negative_zero = ( T, done ) ->
  WG              = require '../../../apps/webguy'
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_can_use_detached_type_of_method = ( T, done ) ->
  WG              = require '../../../apps/webguy'
  { type_of }     = types
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_type_regex = ( T, done ) ->
  WG              = require '../../../apps/webguy'
  #.........................................................................................................
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_has_type_for_negative_zero = ( T, done ) ->
  WG              = require '../../../apps/webguy'
  #.........................................................................................................
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_has_data_property = ( T, done ) ->
  WG              = require '../../../apps/webguy'
  #.........................................................................................................
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_ordering_of_field_and_isa_tests = ( T, done ) ->
  WG              = require '../../../apps/webguy'
  #.........................................................................................................
  collector       = []
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_can_use_subobject_fields = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype { errors: false, }
  noresult          = Symbol 'noresult'
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_create_has_correct_binding = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype { errors: false, }
  collector         = []
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_create_may_return_frozen_sealed_value = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype { errors: false, }
  collector         = []
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_equals_available_as_module_static_method = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
...
#-----------------------------------------------------------------------------------------------------------
@___x__intertype_asyncfunction_isnt_a_function = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype { errors: false, }
  #.........................................................................................................
...
#-----------------------------------------------------------------------------------------------------------
@___x__override_types_are_honored = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype { errors: false, }
  { declare }       = types
...
#-----------------------------------------------------------------------------------------------------------
@___x__can_clone_instance = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
...
#-----------------------------------------------------------------------------------------------------------
@___x__can_replace_declarations = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype()
  { declare
...
#-----------------------------------------------------------------------------------------------------------
@___x__can_delete_and_redeclare_types = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype()
  { declare
...
#-----------------------------------------------------------------------------------------------------------
@___x__detect_circular_declarations = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype()
  { declare
...
#-----------------------------------------------------------------------------------------------------------
@___x__strange_naming_bug = ( T, done ) ->
  # T?.halt_on_error()
...
#-----------------------------------------------------------------------------------------------------------
@___x__throws_validation_error_for_unfit_arguments = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype()
  { declare
...
#-----------------------------------------------------------------------------------------------------------
@___x__recognize_classes = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype()
  { declare
...
#-----------------------------------------------------------------------------------------------------------
@___x__is_extension_of_recognizes_derivatives = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype()
  { declare
...
#-----------------------------------------------------------------------------------------------------------
@___x__is_extension_of_allows_all_values = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype()
  { declare
...
#-----------------------------------------------------------------------------------------------------------
@___x__can_use_either_default_or_template = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  #.........................................................................................................
  do ->
...
#-----------------------------------------------------------------------------------------------------------
@___x__can_use_freeze_true_false_deep_shallow = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype } = require '../../../apps/intertype'
  #.........................................................................................................
  do =>
...
#-----------------------------------------------------------------------------------------------------------
@___x__knowntype_metatype = ( T, done ) ->
  # T?.halt_on_error()
  { Intertype     } = require '../../../apps/intertype'
  types             = new Intertype()
