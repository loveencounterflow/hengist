...
@parse_stars_using_toposort = ( T, done ) ->
  ...
  #.........................................................................................................
  probes_and_matchers = [
    [ '*abc*', "[md:star1,(1:0)(1:1),='*'][md:other,(1:1)(1:4),='abc'][md:star1,(1:4)(1:5),='*'][md:$eof,(1:5)(1:5),='']", null ]
    [ '*abc\\*', "[md:star1,(1:0)(1:1),='*'][md:other,(1:1)(1:4),='abc'][md:escchr,(1:4)(1:6),='\\\\*',chr:'*'][md:$eof,(1:6)(1:6),='']", null ]
    [ '**abc**', "[md:star2,(1:0)(1:2),='**'][md:other,(1:2)(1:5),='abc'][md:star2,(1:5)(1:7),='**'][md:$eof,(1:7)(1:7),='']", null ]
    ]
  #.........................................................................................................
