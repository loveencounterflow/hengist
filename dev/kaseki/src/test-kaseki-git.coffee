...
@kaseki_git_status_sb = ( T, done ) ->
  ...
  GUY.temp.with_directory ({ path: remote_path, }) ->
    ...
    GUY.temp.with_directory ({ path: work_path, }) ->
      ...
      T?.eq local.status(), { local_branch: 'main', remote_branch: null, ahead_count: 0, behind_count: 0, dirty_count: 1 }
      local._add_and_commit_all "first!"
      local.ic.spawn 'git', 'branch', '-m', 'main', 'renamed'
      info '^76-4^', local.status()
      T?.eq local.status(), { local_branch: 'renamed', remote_branch: null, ahead_count: 0, behind_count: 0, dirty_count: 0 }
      #.....................................................................................................
      ...
      T?.eq local.status(), { local_branch: 'renamed', remote_branch: 'hoopla/renamed', ahead_count: 0, behind_count: 0, dirty_count: 0 }
      #.....................................................................................................
      FS.appendFileSync ( PATH.join work_path, 'foo.txt', ), "helo world"
      T?.eq local.status(), { local_branch: 'renamed', remote_branch: 'hoopla/renamed', ahead_count: 0, behind_count: 0, dirty_count: 1 }
      local._add_and_commit_all "second!"
      info '^76-7^', local.status()
      T?.eq local.status(), { local_branch: 'renamed', remote_branch: 'hoopla/renamed', ahead_count: 1, behind_count: 0, dirty_count: 0 }
