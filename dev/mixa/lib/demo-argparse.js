(function() {
  'use strict';
  var AP, CND, HelpFormatter, _strip_ansi, badge, configuration, debug, echo, freeze, help, info, lets, parser, rpr, test, types, urge, version, warn, whisper;
  ...
  HelpFormatter = class HelpFormatter extends AP.RawDescriptionHelpFormatter {
    // executes parent _split_lines for each line of the help, then flattens the result
    _split_lines(text, width) {
      return [].concat(...((text.split('\n')).map((line) => {
        return super._split_lines(line, width);
      })));
    }
...
//# sourceMappingURL=demo-argparse.js.map