(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.declare('not_given', function(x) {
    return (x === '') || (x == null) || (this.isa.nan(x));
  });

  //-----------------------------------------------------------------------------------------------------------
  this.declare('intertext_parsers_lexer_token_matcher', {
    tests: {
      "x is a regex, a nonempty_text, or a function": function(x) {
        if (this.isa.regex(x)) {
          return true;
        }
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.declare('intertext_parsers_lexer_token_description', {
    tests: {
      "x is an object": function(x) {
        return this.isa.object(x);
      },
      "x.match is a valid token matcher": function(x) {
        return this.isa.intertext_parsers_lexer_token_matcher(x.match);
      },
      "x.push_mode is an optional nonempty_text": function(x) {
        return (x.push_mode == null) || this.isa.nonempty_text(x.push_mode);
      },
      "x.switch_mode is an optional nonempty_text": function(x) {
        return (x.switch_mode == null) || this.isa.nonempty_text(x.switch_mode);
      },
      "x.pop_mode is an optional boolean": function(x) {
        return (x.pop_mode == null) || this.isa.boolean(x.pop_mode);
      },
      "x.line_breaks is an optional boolean": function(x) {
        return (x.line_breaks == null) || this.isa.boolean(x.line_breaks);
      },
      "x.group is an optional nonempty_text": function(x) {
        return (x.group == null) || this.isa.nonempty_text(x.group);
      }
    }
  });
