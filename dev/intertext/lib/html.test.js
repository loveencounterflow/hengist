(function() {
  'use strict';
  var CND, _parse_compact_tagname, alert, badge, debug, echo, help, info, jr, log, rpr, test, urge, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  _parse_compact_tagname = function(compact_tagname, strict = false) {
  ...
  // TESTS
  //-----------------------------------------------------------------------------------------------------------
  this["HTML parse compact tagname"] = function(T, done) {
