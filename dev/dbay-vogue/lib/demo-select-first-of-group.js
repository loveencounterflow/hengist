(function() {
  'use strict';
  var CND, H, badge, debug, demo_1, echo, help, info, rpr, types, urge, warn, whisper;
...
order by product;`);
    //---------------------------------------------------------------------------------------------------------
    db(SQL`insert into product_sales(product,order_date, sale)
...
//# sourceMappingURL=demo-select-first-of-group.js.map