(function() {
  'use strict';
  var CND, PATH, badge, debug, echo, get_icql_settings, help, info, inspect, jr, rpr, test, urge, warn, whisper, xrpr, xrpr2;
  ...
  this["oneliners"] = function(T, done) {
    var IC, ICQL, db, demo_path, intercourse_path, probes_and_matchers;
  ...
  this["as_sql"] = async function(T, done) {
    var ICQL, db, error, i, len, matcher, probe, probes_and_matchers;
    ICQL = require('../../../../apps/icql');
    PATH = require('path');
    db = ICQL.bind(get_icql_settings());
...
//.........................................................................................................
  ...
  this["fragments return interpolated source text"] = function(T, done) {
    var ICQL, db, first, key, last, middle, status, value;
    ICQL = require('../../../../apps/icql');
    db = ICQL.bind(get_icql_settings());
    // debug 'µ44430', db
    // debug 'µ44430', db.$.sql
