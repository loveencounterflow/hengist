(function() {
  ...
  show_phrases_table = function(gdb) {
    return console.table(gdb.dba.list(gdb.dba.query(SQL`select * from phrases;`)));
  };
  ...
  copy_derivatives_to_phrases = function(gdb) {
    ...
    var changes;
    ({changes} = gdb.dba.run(SQL`insert into phrases as p1 ( s, p, o, a )
  ...
  derive_phrases = function(gdb) {
    ...
    ({changes} = gdb.dba.run(SQL`insert into derivatives as ir ( s, p, o, a )
  select distinct
      p1.s as s,
      p2.p as p,
      p2.o as o,
