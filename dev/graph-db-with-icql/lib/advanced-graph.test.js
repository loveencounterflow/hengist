(function() {
  'use strict';
  var CND, H, I, L, PATH, SQL, X, badge, debug, echo, help, info, insert_formulas_and_components, isa, jr, rpr, test, type_of, types, urge, validate, validate_list_of, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  insert_formulas_and_components = function(gdb) {
    var cfg, cformula, component, formula, formulas, glyph, glyphs_from_formula, i, j, len, len1, ref, registry, walk_glyphs_from_formula;
    //.........................................................................................................
    glyphs_from_formula = function(formula) {
      return Array.from(formula);
    };
    walk_glyphs_from_formula = function*(formula) {
      return (yield* glyphs_from_formula);
    };
    cfg = {
      columns: ['glyph'],
    ...
    //.........................................................................................................
    gdb.dba.function('insert_glyph', {
      deterministic: true,
      varargs: false
    }, function(glyph) {
      urge(CND.reverse('^344^ inserting', glyph));
      gdb.dba.run(SQL`insert into nodes ( body ) values ( '{ "id": "' ? '", "type": "glyph" }' )
  on conflict ( id ) do nothing;`, [glyph]);
      return null;
    });
    // #.........................................................................................................
    // sql = SQL"""
...
//.........................................................................................................
    for (glyph in registry) {
      ...
      formulas = ((cformula.replace(/[{}]/g, '')).split('|')).slice(1);
      gdb.upsert_node({
        id: glyph,
        type: 'glyph'
      });
      for (i = 0, len = formulas.length; i < len; i++) {
        ...
        gdb.insert_edge(glyph, formula, {
          type: 'has_formula'
        });
        debug('^338^', glyphs_from_formula(formula));
        ref = glyphs_from_formula(formula);
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["Graphdb: deleting edges and nodes"] = function(T, done) {
    var Graphdb, schema;
    // T.halt_on_error()
    ...
    (() => {      //.........................................................................................................
      ...
      H.show_graph(gdb);
      T.eq(H.get_node_ids(gdb), ['口', '國', '域', '或']);
      return T.eq(H.get_edge_ids(gdb), [['口', '或'], ['國', '或'], ['或', '口'], ['或', '域']]);
    })();
    (() => {      //.........................................................................................................
      var gdb;
      gdb = new Graphdb({
      ...
      H.insert_kanji_edges(gdb);
      gdb.delete_edges('或');
      return H.show_graph(gdb);
    })();
    return typeof done === "function" ? done() : void 0;
  };

  //-----------------------------------------------------------------------------------------------------------
  this["Graphdb: xxx"] = function(T, done) {
    var Graphdb, schema;
    // T.halt_on_error()
    ({Graphdb} = require('./graph-db'));
    // path        = '/tmp/icql-graph.db'
...
//# sourceMappingURL=advanced-graph.test.js.map