(function() {
  'use strict';
  var CND, badge, debug, echo, help, info, inspect, jr, rpr, test, test_basics, urge, warn, whisper;
  ...
  this["VNR 1"] = function(T, done) {
    test_basics(T, require('../../../apps/datom/lib/vnr'));
    test_basics(T, (require('../../../apps/datom')).VNR);
    done();
    return null;
  };
  ...
  this["VNR sort 2"] = async function(T, done) {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ordering = ref[i];
      VNR = new (require('../../../apps/datom')).VNR.Vnr({ordering});
      ref1 = matchers[ordering];
      // VNR     = new ( require '../../../apps/datom' ).VNR.Vnr { ordering, validate: false, }
