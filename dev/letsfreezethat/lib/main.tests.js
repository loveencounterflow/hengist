(function() {
  'use strict';
  var CND, assert, badge, debug, echo, help, info, isa, join_paths, jr, lft_nofreeze_path, lft_path, log, rpr, test, type_of, types, urge, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["freeze, modify object copy"] = function(T, done) {
    var a, d, e, freeze, lets, thaw;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["null, primitive values are kept as-is"] = function(T, done) {
    /* from SQLite File Mirror: */
    var defaults, freeze, lets, thaw;
    ({lets, freeze, thaw} = require(lft_path));
    defaults = lets({
      mirrors: {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["use nofreeze option for speedup"] = function(T, done) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["functions are kept as functions"] = function(T, done) {
    (() => {      //.........................................................................................................
      var d, freeze, lets, thaw;
      ({lets, freeze, thaw} = require(lft_path));
      d = lets({
        e: {
          f: (function(x) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["LFTNG lets makes a copy on entry, not on exit"] = function(T, done) {
    var LFT, d1, d2_ref, d3, freeze, lets, thaw;
    LFT = require(lft_path);
    ({lets, freeze, thaw} = LFT);
    //.........................................................................................................
    d1 = {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["LFTNG thaw makes a copy, freeze does not"] = function(T, done) {
    var LFT, d1, d2, d3, d4, freeze, lets, thaw;
    LFT = require(lft_path);
    ({lets, freeze, thaw} = LFT);
    //.........................................................................................................
    d1 = {
