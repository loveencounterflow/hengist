(function() {
  'use strict';
  var CND, alert, badge, debug, demo, demo_test_for_generator, echo, get_probes_and_matchers, help, info, log, njs_path, praise, rpr, test, type_of_v3, urge, warn, whisper;
...
//.........................................................................................................
  ...
  this["es6classes type detection devices (prototype)"] = function(T, done) {
    var INTERTYPE, Intertype, color, column_width, domenic_denicola_device, h, headers, i, idx, intertype, isa, j, js_type_of, last_idx, lc_result, len, len1, mark_miller_device, matcher, probe, raw_result, raw_results, ref, results, string_tag, type_of_v4, type_of_v4_type, validate;
    INTERTYPE = require('../../../apps/intertype');
    ({Intertype} = INTERTYPE);
    intertype = new Intertype();
