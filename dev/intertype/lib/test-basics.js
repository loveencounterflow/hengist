(async function() {
  'use strict';
  var GTNG, GUY, TMP_types, Test, alert, debug, demo_1, echo, help, info, inspect, log, plain, praise, reverse, rpr, sample_declarations, tasks, urge, warn, whisper;
