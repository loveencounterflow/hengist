...
@demo_stdlib_api = ( cfg ) ->
  ...
  db ->
    ...
    debug '^34534-8^', db.dt_now { subtract: [ 1, 'week', ], }
    debug '^34534-9^', db.dt_now { subtract: [ 1, 'month', ], }
    debug '^34534-10^', db.dt_now { add: [ 1, 'week', ], }
    debug '^34534-11^', db.dt_now { subtract: [ 1, 'week', ], add: [ 1, 'week', ], }
