...
create view dbay_create_table_statements_MIRAGE as
  ...
  union all select distinct 10, null, 10, 2, null, '.bail on'                             from x
  union all select distinct 10, null, 10, 3, null, 'pragma foreign_keys = false;'         from x
  union all select distinct 10, null, 10, 4, null, 'begin transaction;'                   from x
