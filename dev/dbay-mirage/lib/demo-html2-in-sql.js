(function() {
  'use strict';
  var CND, DBay, FS, HDML, PATH, SQL, X, badge, debug, echo, equals, guy, help, info, isa, rpr, tabulate2, to_width, type_of, types, urge, validate, validate_list_of, warn, whisper, width_of;
  ...
  //-----------------------------------------------------------------------------------------------------------
  tabulate2 = function(title, rows) {
    return X.tabulate(title, rows);
  };
...
insert into mirror ( dsk, tid, sgl, tag, atrid, text )
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.demo_htmlish = function() {
    var HTMLISH, html, i, len, probes, rows;
    ({HTMLISH} = require('../../../apps/dbay-mirage/lib/htmlish-parser'));
    probes = [`<h1#c1.foo>Article</h1>\n<div>Copy <br x=y/> <em>text</em>.</div>`, `<em x=42/what/ is this?`];
...
//# sourceMappingURL=demo-html2-in-sql.js.map