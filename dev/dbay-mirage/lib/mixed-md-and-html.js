(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.demo_transcribe_markdown_to_html = function(cfg) {
    var $, $show, Moonriver, mr;
     ...
     *     send d
     */
    mr.push(["**a**", "*a*", "A paragraph as a *demonstration* of what **can** be done.", "Another *piece* with *several* emphases.", "Another ***piece* with *several*** nested emphases.", "a [fancy](http://fan.cy) link", "a [*fancy*](http://fan.cy) link", "wanna **`code` some**?"]);
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.demo_tunneling_all_htmlish = function(cfg) {
    var TIMETUNNEL, _tunnel;
    TIMETUNNEL = require('timetunnel');
    _tunnel = function(text) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.demo_mixed_md_and_html = function(cfg) {
    ...
    //.........................................................................................................
    dsk = 'md';
    path = 'dbay-rustybuzz/mixed-md-and-html.html';
  ...
  if (require.main === module) {
    (() => {
      ...
      return this.demo_transcribe_markdown_to_html();
    })();
  }

}).call(this);

//# sourceMappingURL=mixed-md-and-html.js.map