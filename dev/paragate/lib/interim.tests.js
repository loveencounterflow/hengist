(function() {
  'use strict';
  var CND, INTERTEXT, alert, as_text, badge, condense_token, condense_tokens, debug, delete_refs, echo, help, info, isa, jr, lets, log, rpr, test, type_of, urge, warn, whisper;
