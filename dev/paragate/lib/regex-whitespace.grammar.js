(function() {
  'use strict';
  var CND, GRAMMAR, INTERTEXT, MAIN, Multimix, Rxws_grammar, alert, assign, badge, debug, echo, freeze, help, info, isa, jr, lets, log, rpr, rxws_grammar, space_re, type_of, types, urge, validate, warn, whisper;
  ...
  // #-----------------------------------------------------------------------------------------------------------
  // rxws_lexer = new Lexer token_defs, { positionTracking: 'full', ensureOptimizations: false, }
  ...
  this._as_blocks = function(dlines) {
    ...
    consolidate = function($key, buffer) {
      var $vnr, d, first, last, level, ref, start, stop, text;
      first = buffer[0];
