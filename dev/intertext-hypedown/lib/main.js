(function() {
  'use strict';
  var DATOM, GUY, H, PATH, SQL, after, alert, debug, echo, equals, guy, help, info, inspect, isa, lets, log, new_datom, new_token, plain, praise, rpr, show_lexer_as_table, stamp, test, type_of, types, urge, validate, validate_list_of, warn, whisper;
