(function() {
  'use strict';
  var CND, GRAMMAR, INTERTEXT, alert, assign, badge, dd, debug, echo, freeze, help, info, isa, jr, lets, log, rpr, type_of, types, urge, validate, warn, whisper;
...
/* NOTE we assume that unique kids exist and that values are stored in source order */
  ...
  //-----------------------------------------------------------------------------------------------------------
  module.exports = GRAMMAR.new_grammar('Htmlish', this);
