(function() {
  ...
  var CND, INTERTEXT, after, assign, badge, bar_from_percentage, debug, declare, echo, f0, f01a, f0a, f0l, f1s, f3, f3s, f9, first_of, help, info, isa, jr, last_of, nf, rpr, size_of, type_of, urge, validate, warn, whisper,
  ...
  this.show_totals = function(me) {
    ...
    var bar, best_ops, i, len, ops, ops_txt, record, records, results, rops, rops_txt, test_name, test_name_txt, xxx_txt;
    ...
    for (i = 0, len = records.length; i < len; i++) {
      ...
      results.push(info(test_name_txt, ops_txt, 'Hz', xxx_txt, rops_txt, '%', bar));
    }
    return results;
  };
  ...
  this.benchmark = function(me, n, show, parent, test_name) {
    ...
    return new Promise(benchmark = async(resolve) => {
      var count, count_txt, dt1ns, dt1s, dt2ns, dt2s, dt2s_txt, error, nspc, nspc_txt, ops, ops_txt, t0ns, t1ns, t2ns, test, test_name_txt;
      if (test_name == null) {
